...
public class SimpleApplication extends IsisWicketApplication {
	...
	public Session newSession(final Request request, final Response response) {
		...
		// else demo mode
		final AuthenticatedWebSessionForIsis s = (AuthenticatedWebSessionForIsis) super
				.newSession(request, response);
		IRequestParameters requestParameters = request.getRequestParameters();
		final org.apache.wicket.util.string.StringValue user = requestParameters
				.getParameterValue("user");
		final org.apache.wicket.util.string.StringValue password = requestParameters
	...
	private static String readLines(final Class<?> contextClass,
