...
public class HorasDoctoresServicio extends AbstractFactoryAndRepository {
	...
	public HorasDoctores crearTurnos(
			...
			@ParameterLayout(named = "Horas Mañana Desde") final HorasMañanaEnum horasMañanaDesde,
			@ParameterLayout(named = "Horas Mañana Hasta") final HorasMañanaEnum horasMañanaHasta,
			@ParameterLayout(named = "Horas Tarde Desde") final HorasTardeEnum horasTardeDesde,
			@ParameterLayout(named = "Horas Tarde Hasta") final HorasTardeEnum horasTardeHasta) {
